...
if __name__ == "__main__":
    ...
    parser.add_argument("--temporal_path", type=str, default='/data/webgpt/IIA/dataset/hotpot/results/temporal.json', help="Path to the config file")
    parser.add_argument("--output_path", type=str, default='/data/webgpt/IIA/dataset/hotpot/results/results.json', help="Path to the config file")
    parser.add_argument("--evaluate_path", type=str, default='/data/webgpt/IIA/dataset/hotpot/evaluation/evaluation.txt', help="Path to the config file")
