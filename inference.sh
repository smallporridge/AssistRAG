...
mode="rag"
temporal_path="/AssistRAG/dataset/${dataset_name}/results/assist_${model_name}.json"
output_path="/AssistRAG//dataset/${dataset_name}/results/answer_${model_name}_${llm_name}.json"
evaluate_path="/AssistRAG//dataset/${dataset_name}/evaluation/evaluation.txt"
